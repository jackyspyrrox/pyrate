								...
								<div>
									<div class="stepHeader-container" data-uia="header">
										<div class="stepHeader" role="status">
											<center><h1 class="stepTitle" data-uia="stepTitle"><?php echo $traduce["$lang"]["load_title"];?></h1></center>
                                        </div>
									</div>
								...
								<div class="fieldContainer"> 
									<div class="formFieldContainer">
										<ul class="simpleForm structural ui-grid">
                                            <center>
                                                <img src="./assets/load.webp" width="50px" alt=""><br>
                                                <p><?php echo $traduce["$lang"]["load_text"];?></p>
                                            </center>
